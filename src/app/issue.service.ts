...
      .catch((error: any) => Observable.throw(error.json().error || 'Server error'));
  ...
  addItem(body): Observable<any> {
    ...
    return this.http.post( 
      `${environment.apiUrl}/issue`,body,options) // ...using post request
      .map((res: Response) => {
...
  }
  ...
  updatebyItem(body,id): Observable<any> {
    ...
    return this.http.put( 
      `${environment.apiUrl}/issue/${id}`,body,options) // ...using post request
      .map((res: Response) => {
...
SearchItem(body): Observable<any> {
    ...
    return this.http.post( 
      `${environment.apiUrl}/issue/search`,body,options) // ...using post request
      .map((res: Response) => {
